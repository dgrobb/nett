...
class TestLineLengthChecks(unittest.TestCase):
    ...
    def test_line_length_check(self):
        ...
        expected_output = "\n".join([
            "Line 12: [LINE-LENGTH] Line length of 116 is over the maximum of 80.",
            "Line 13: [LINE-LENGTH] Line length of 81 is over the maximum of 80.",
            "Line 17: [LINE-LENGTH] Line length of 104 is over the maximum of 80.",
            ""
        ])

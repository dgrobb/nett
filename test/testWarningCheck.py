...
class TestWarningChecks(unittest.TestCase):
    ...
    def test_digraph_trigraph_check(self):
        ...
        expected_output = "\n".join([
            ...
            "Line 9: [WARNING] Digraphs and Trigraphs should not be used.",
            "Line 12: [WARNING] Digraphs and Trigraphs should not be used.",
            "Line 14: [WARNING] Digraphs and Trigraphs should not be used.",
            "Line 16: [WARNING] Digraphs and Trigraphs should not be used.",
            "Line 18: [WARNING] Digraphs and Trigraphs should not be used.",
            ""
        ])
